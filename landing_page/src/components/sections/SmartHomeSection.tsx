...
import GestureGrid from "@/components/mockups/GestureGrid";
...
const cards: CategoryCard[] = [
  ...
  },
  {
    ...
    description:
      "방과 기기별 전력 사용량을 실시간으로 추적하고, 사용량이 급증하면 바로 알려드립니다. 대기전력이 많은 기기는 자동으로 절전 모드를 제안해요.",
    bullets: [
      "기기·방별 실시간 전력 사용량 추적",
      "사용량 급증 시 즉시 알림",
      "대기전력 높은 기기 절전 모드 자동 제안",
    ],
    media: (
      <AreaChart
        label="오늘 전력 사용량"
