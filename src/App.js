...
// 	<path fill="currentColor" d="M5.07 5.26c-.27-1.78 2.22-2.31 2.61-.5l.68 3.47l2.52.01c.74 0 1.12.61 1.12 1.17v4.73c0 1.15-1.59 1.14-1.59-.02v-3.67H7.19c-.75 0-1.22-.54-1.34-1.15zm-.3-3.6c-.05.58.23 1.13.7 1.43c.48.31 1.09.31 1.56 0c.48-.3.75-.85.71-1.43A1.55 1.55 0 0 0 7.03.23c-.47-.31-1.08-.31-1.56 0c-.47.3-.75.85-.7 1.43M3.02 7.12c-.18-.99 1.08-1.22 1.25-.23l.56 3.09c.12.64.58 1.2 1.24 1.4c.19.07.4.07.6.09l1.82.01c.97-.01.96 1.31-.01 1.3l-1.91-.01c-.3 0-.59-.04-.89-.13c-1.13-.35-1.92-1.31-2.13-2.43z"></path>
//  </svg>
